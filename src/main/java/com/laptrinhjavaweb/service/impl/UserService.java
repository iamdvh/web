...
//        oldUser.setFullName(updateUser.getFullName());
    ...
    @Override
    public Map<Long, String> findByStatusAndRole() {
//        return userRepository.findByStatusAndRoles_Code(1, "USER").stream()
//                .collect(Collectors.toMap(u -> u.getId(), u -> u.getFullName()));
        return null;
    }

    @Override
    public List<StaffDTO> findStaffs(String buildingId) {
        StaffDTO staff1 = new StaffDTO();
        staff1.setId(1L);
        staff1.setFullName("Đào Văn Hiếu");
        staff1.setChecked("checked");

        StaffDTO staff2 = new StaffDTO();
        staff2.setId(2L);
        staff2.setFullName("Nguyễn Thanh Tùng");
        staff2.setChecked("");

        StaffDTO staff3 = new StaffDTO();
        staff3.setId(3L);
        staff3.setFullName("Dương Thị Mỹ Lệ");
